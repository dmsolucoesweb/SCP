...
class LayoutBoletoHsbc {
    ...
    function LayoutHsbc($dadosboleto) {
                ...
                <table cellspacing=0 cellpadding=0 width=666 border=0>
                    <tr>
                        <td class=cp width=150><span class='campo'><IMG 
                                    ...
                                    border=0></span></td>
                        <td width=3 valign=bottom><img height=22 src=imagens/3.png width=1 border=0></td>
        ...
        <table cellspacing=0 cellpadding=0 width=666 border=0>
            <tr>
                <td class=cp width=150><span class='campo'><IMG src='imagens/logohsbc.jpg' width='144' height='30' border=0></span></td>
                <td width=1 valign=bottom><img height=22 src=imagens/1.png width=1 border=0></td>
