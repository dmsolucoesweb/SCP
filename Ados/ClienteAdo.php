...
class ClienteAdo extends ADO {
    ...
    public function consultaObjetoPeloId($id) {
        ...
        if ($resultado) {
            ...
            parent::setMensagem("Erro no select de cliente: " . parent::getBdError());
            return false;
        }
    ...
    public function consultaArrayDeObjeto() {
        ...
        if ($resultado) {
            ...
            parent::setMensagem("Erro no select de clientes: " . parent::getBdError());
            return false;
        }
    ...
    public function insereObjeto(Model $clienteModel) {
        ...
        if ($resultado) {
            ...
            parent::setMensagem("Erro no insert de clientes: " . parent::getBdError());
            return false;
        }
    }
    ...
    public function excluiObjeto(Model $clienteModel) {
        ...
        if ($resultado) {
            ...
            parent::setMensagem("Erro no delete de cliente: " . parent::getBdError());
            return false;
        }
    }
